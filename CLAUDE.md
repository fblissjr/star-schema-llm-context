...
Pattern library for Kimball-style dimensional modeling as the business rules and state persistence layer for data-driven LLM agent loops. Documentation and design specs -- not a code library (yet).

## what this repo is

Design documents and reference implementation specs for using DuckDB star schemas as the business rules layer for LLM agent routing. Working implementation lives in [fb-claude-skills/skill-maintainer/scripts/store.py](https://github.com/fblissjr/fb-claude-skills/blob/main/skill-maintainer/scripts/store.py).
...
| `README.md` | Research thesis, data-driven flywheel, pattern summary |
